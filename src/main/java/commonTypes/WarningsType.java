 ...
 *       &lt;sequence>
 *         &lt;element name="Warning" type="{}V172_WarningType" maxOccurs="99"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class WarningsType {
    ...
    protected List<V172WarningType> warning;
     ...
     * {@link V172WarningType }
     * 
     * 
     */
    public List<V172WarningType> getWarning() {
        if (warning == null) {
            warning = new ArrayList<V172WarningType>();
        }
        return this.warning;
    }
