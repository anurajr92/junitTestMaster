 ...
 *       &lt;attGroup ref="{}AmountCurrencyOptGroup"/>
...
@XmlSeeAlso({
    commonTypes.TaxExemptionType.Total.class,
    commonTypes.GroupBudgetType.Amount.class,
    commonTypes.PersonBudgetType.Amount.class,
    SimpleCurrencyPriceType.class,
    commonTypes.EquivFareTransactionType.Amount.class,
    commonTypes.TotalFareTransactionType.Amount.class,
    commonTypes.BaseFareTransactionType.Amount.class,
    commonTypes.TaxDetailType.Total.class,
    commonTypes.FeeSurchargeType.Total.class
})
