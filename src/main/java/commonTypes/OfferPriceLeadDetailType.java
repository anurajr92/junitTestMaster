 ...
 *                     &lt;element ref="{}OriginDestinationReference"/>
...
@XmlSeeAlso({
    commonTypes.OfferPriceLeadType.RequestedDate.class
})
public class OfferPriceLeadDetailType {
    ...
    public static class PriceDetail {
        ...
        @XmlElementRefs({
            ...
            @XmlElementRef(name = "OriginDestinationReference", type = JAXBElement.class, required = false)
        })
